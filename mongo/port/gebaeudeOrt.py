...
#    ort.update_many({}, {"$unset": {"id1":""}})
    gebaeude_leer = gebaeude.find_one({"name_de": "-"})
    ort.insert_one({"name_de": "-", "name_en": "", "kurzname": "", "gebaeude": gebaeude_leer["_id"], "raum": "", "groesse": 0, "sichtbar": True, "kommentar": "", "rang": 200})

    import schema
    mongo_db.command("collMod", "gebaeude", validator = schema.gebaeude_validator)
    mongo_db.command("collMod", "ort", validator = schema.ort_validator)
