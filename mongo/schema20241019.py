...
statistikveranstaltung_validator = {
    "$jsonSchema": {
        "bsonType": "object",
        "title": "Eine Statistik für Veranstaltungen.",
        "required": ["name", "rang", "rubrik", "studiengang", "stat", "kommentar"],
        "properties": {
            "name": {
                "bsonType": "string",
            ...
            "rubrik": {
                "bsonType": "array",
                "description": "Für Veranstaltungen in diesen Rubriken wird die Statistik erhoben.",
                "items": {
                    "bsonType": "objectId",
                    "description": "Eine Rubrik.",
                }
            },
            "studiengang": {
                "bsonType": "array",
                "description": "Es gibt ein Ergebnis für jeden dieser Studiengänge.",
                "items": {
                    "bsonType": "objectId",
            ...
            "stat": {
                ...
                "items": {
                    ...
                    "required": ["veranstaltung", "wert", "kommentar"],
                    "properties": {
                        "veranstaltung": {
                            "bsonType": "objectId",
...
statistiksemester_validator = {
    "$jsonSchema": {
        "bsonType": "object",
        "title": "Eine Statistik für Semester.",
        "required": ["name", "rang", "semester", "studiengang", "stat", "kommentar"],
        "properties": {
            "name": {
                "bsonType": "string",
                "description": "Name der Statistik -- required"
            ...
            "semester": {
                "bsonType": "array",
                "description": "Konkrete Semester, in denen die Statistik erhoben werden soll.",
                "items": {
                    "bsonType": "objectId",
                    "description": "Das konkrete Semester, in dem ausgewertet werden soll.",
                }
            },
            "studiengang": {
                "bsonType": "array",
                "description": "Konkrete Studiengänge, für die die Statistik erhoben werden soll.",
                "items": {
                    "bsonType": "objectId",
                    "description": "Das konkrete Semester, in dem ausgewertet werden soll.",
                }
...
person_validator = {
    "$jsonSchema": {
        ...
        "required": ["name", "vorname", "name_prefix", "titel", "rang", "tel", "email", "sichtbar", "hp_sichtbar", "semester", "veranstaltung", "kommentar"],
        "properties": {
            "name": {
                "bsonType": "string",
