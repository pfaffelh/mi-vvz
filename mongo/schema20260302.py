...
person_validator = {
    "$jsonSchema": {
        ...
        "required": ["name", "name_en", "vorname", "name_prefix", "titel", "gender", "vorgesetzte", "kennung", "rang", "tel1", "tel2", "email1", "email2", "raum1", "gebaeude1", "raum2", "gebaeude2", "url", "sichtbar", "hp_sichtbar", "einstiegsdatum", "ausstiegsdatum", "abwesend_start", "abwesend_ende", "semester", "code", "veranstaltung", "kommentar", "kommentar_html", "bearbeitet"],
        "properties": {
            "name": {
                "bsonType": "string",
