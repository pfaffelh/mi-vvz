...
hilfe_validator = {
    "$jsonSchema": {
        "bsonType": "object",
        "title": "Ein in der App geänderter Hilfetext eines Widgets.",
        "required": ["key", "text", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
            ...
            "key": {
                "bsonType": "string",
                "description": "Der Schlüssel des Hilfetextes, siehe util.HILFE -- required"
            },
            "text": {
                "bsonType": "string",
                "description": "Der geänderte Hilfetext -- required"
            }
        }
    }
}
...
notiz_validator = {
    "$jsonSchema": {
        "bsonType": "object",
        "title": "Eine Notiz, die auf der Seite Dokumentation angezeigt wird.",
        "required": ["text", "rang", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
                "description": "Wer hat wann zuletzt bearbeitet."
            ...
            "text": {
                "bsonType": "string",
                "description": "Der Text der Notiz (Markdown) -- required"
            },
            "rang": {
                "bsonType": ["int", "long"],
...
planungveranstaltung_validator = {
    "$jsonSchema": {
        ...
        "required": ["name", "sws", "regel", "rang", "kommentar", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
                "description": "Wer hat wann zuletzt bearbeitet."
...
planung_validator = {
    "$jsonSchema": {
        "bsonType": "object",
        "title": "Die Planung einer Planungsveranstaltung für ein Semester.",
        "required": ["veranstaltung", "sem", "dozent", "kommentar", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
                "description": "Wer hat wann zuletzt bearbeitet."
            ...
            "sem": {
                "bsonType": "string",
                "description": "Kurzname des Semesters, zB 2026WS -- required"
            },
            "dozent": {
                "bsonType": "array",
                "description": "Die Personen, die die Veranstaltung halten -- required",
                "items": {
                    "bsonType": "objectId",
...
gebaeude_validator = {
    "$jsonSchema": {
        ...
        "required": ["name_de", "name_en", "kurzname", "adresse", "url", "rang", "sichtbar", "kommentar", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
                "description": "Wer hat wann zuletzt bearbeitet."
...
raum_validator = {
    "$jsonSchema": {
        ...
        "required": ["name_de", "name_en", "kurzname", "gebaeude", "raum", "groesse", "rang", "sichtbar", "kommentar", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
                "description": "Wer hat wann zuletzt bearbeitet."
...
person_validator = {
    "$jsonSchema": {
        ...
        "required": ["name", "name_en", "vorname", "name_prefix", "titel", "abschluss", "gender", "vorgesetzte", "kennung", "rang", "tel1", "tel2", "email1", "email2", "raum1", "gebaeude1", "raum2", "gebaeude2", "url", "sichtbar", "hp_sichtbar", "einstiegsdatum", "ausstiegsdatum", "kommentar_stelle", "abwesend_start", "abwesend_ende", "kommentar_abwesend", "semester", "code", "veranstaltung", "beisitz", "kommentar", "kommentar_html", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
                "description": "Wer hat wann zuletzt bearbeitet."
            ...
            "gender": {
                "bsonType": "string",
                "enum": ["m", "w", "d", "kA"],
                "description": "Gender der Person"
            },
            "vorgesetzte": {
                "bsonType": "array",
                "description": "Liste der Vorgesetzten.",
                "items": {
                    "bsonType": "objectId",
                    "description": "Ein:e Vorgesetzte:r."
                }
            },
            "kennung": {
                "bsonType": "string",
            ...
            "einstiegsdatum": {
                "bsonType": ["null", "date"],
                "description": "Gibt -- falls vorhanden -- das Einstiegsdatum der Person an."
            },
            "ausstiegsdatum": {
                "bsonType": ["null", "date"],
                "description": "Gibt -- falls vorhanden -- das Ausstiegsdatum der Person an."
            },
            "kommentar_stelle": {
                "bsonType": "string",
                "description": "Kommentar zur Person für die Webpage"
            ...
            "code": {
                ...
                "items": {
                    "bsonType": "objectId",
                    "description": "must be an _id from the personencode collection"
                }
            },
            "veranstaltung": {
                "bsonType": "array",
            ...
            "beisitz": {
                "bsonType": "array",
                "description": "Beisitze der Person, chronologisch rückwärts sortiert.",
                "items": {
                    "bsonType": "object",
                    "required": ["datum", "anzahl"],
                    "properties": {
                        "datum": {
                            "bsonType": "date",
                            "description": "Datum der Beisitze."
                        },
                        "anzahl": {
                            "bsonType": ["int", "long"],
                            "minimum": 0,
                            "description": "Anzahl der Beisitze an diesem Datum."
                        }
                    }
                }
            }
...
#personencode
personencode_validator = {
    "$jsonSchema": {
        "bsonType": "object",
        "title": "Beschreibung der Codes, die auf der Webpage verwendet werden",
        "required": ["name", "codekategorie", "beschreibung_de", "beschreibung_en", "rang", "kommentar_html", "kommentar", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
                "description": "Wer hat wann zuletzt bearbeitet."
...
personencodekategorie_validator = {
    "$jsonSchema": {
        "bsonType": "object",
        "title": "Beschreibung der Kategorie eines Codes (zB Abteilung) einer Person.",
        "required": ["name_de", "name_en", "beschreibung_de", "beschreibung_en", "rang", "kommentar", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
                "description": "Wer hat wann zuletzt bearbeitet."
...
semester_validator = {
    "$jsonSchema": {
        ...
        "required": ["name_de", "name_en", "kurzname", "rang", "rubrik", "code", "veranstaltung", "hp_sichtbar", "vorspann_kommentare_de", "vorspann_kommentare_en", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
                "description": "Wer hat wann zuletzt bearbeitet."
...
rubrik_validator = {
    "$jsonSchema": {
        ...
        "required": ["titel_de", "titel_en", "untertitel_de", "untertitel_en", "rang", "semester", "prefix_de", "prefix_en", "suffix_de", "suffix_en", "veranstaltung", "kommentar", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
                "description": "Wer hat wann zuletzt bearbeitet."
...
code_validator = {
    "$jsonSchema": {
        "bsonType": "object",
        "title": "Beschreibung der Codes, die auf der Webpage verwendet werden",
        "required": ["name", "codekategorie", "semester", "beschreibung_de", "beschreibung_en", "rang", "kommentar", "veranstaltung", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
                "description": "Wer hat wann zuletzt bearbeitet."
...
codekategorie_validator = {
    "$jsonSchema": {
        ...
        "required": ["name_de", "name_en", "hp_sichtbar", "komm_sichtbar", "beschreibung_de", "beschreibung_en", "rang", "semester", "code", "kommentar", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
                "description": "Wer hat wann zuletzt bearbeitet."
...
studiengang_validator = {
    "$jsonSchema": {
        ...
        "required": ["name", "kurzname", "rang", "modul", "kommentar", "sichtbar", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
                "description": "Wer hat wann zuletzt bearbeitet."
...
modul_validator = {
    "$jsonSchema": {
        ...
        "description": "",
        "required": ["name_de", "name_en", "kurzname", "studiengang", "sichtbar", "kommentar", "rang", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
                "description": "Wer hat wann zuletzt bearbeitet."
...
anforderungkategorie_validator = {
    "$jsonSchema": {
        ...
        "required": ["name_de", "name_en", "kurzname", "rang", "sichtbar", "kommentar", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
                "description": "Wer hat wann zuletzt bearbeitet."
...
anforderung_validator = {
    "$jsonSchema": {
        ...
        "required": ["name_de", "name_en", "anforderungskategorie", "semester", "rang", "sichtbar", "kommentar", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
                "description": "Wer hat wann zuletzt bearbeitet."
...
terminart_validator = {
    "$jsonSchema": {
        ...
        "required": ["name_de", "name_en", "hp_sichtbar", "komm_sichtbar", "cal_sichtbar", "rang", "bearbeitet"],
        "properties": {
            "bearbeitet": {
                "bsonType": "string",
                "description": "Wer hat wann zuletzt bearbeitet."
