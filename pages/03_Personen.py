...
if st.session_state.logged_in:
    ...
    if st.session_state.edit == "" or st.session_state.page != "Person":
        ...
        with st.form(f'ID-{x["_id"]}'):
            ...
            st.write("Semester")
            semester_list = st.multiselect("Semester", [x["_id"] for x in util.semester.find(sort = [("kurzname", pymongo.DESCENDING)])], x["semester"], format_func = (lambda a: tools.repr(util.semester, a, False)), placeholder = "Bitte auswählen")
