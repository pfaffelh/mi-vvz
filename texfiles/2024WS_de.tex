...
\addcontentsline{toc}{subsection}{Studienplanung}
...
\section*{Sprache} 
\addcontentsline{toc}{subsection}{Sprache}
...
\addcontentsline{toc}{subsection}{Verwendbarkeit von Veranstaltungen}
...
%        BSc12 & Bachelor of Science in Mathematik, PO-Version von 2012 \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%  Anforderungen, Studien- und Prüfungsleistunge
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Studien- und Prüfungsleistungen}
\addcontentsline{toc}{subsection}{Studien- und Prüfungsleistungen}


%\ifboolean{Anforderungen}%
%{In der Rubrik "`Verwendbarkeit, Studien- und Prüfungsleistungen"' wird für jede
%im \diesessemester\ \Jahr\ angebotenen Mathematik-Veranstaltung angegeben,
...
%der \href{https://www.math.uni-freiburg.de/lehre/pruefungsamt/modulhandbuecher.html}{Modulhandbücher} dar
%und wurden von der Studienkommission Mathematik am 25.04.2024 verabschiedet.}%
...
%  \item
%    Studierende in den Lehramtsstudiengängen nach GymPO 2010 erkundigen sich bitte bei den
%    jeweiligen Dozent:inn:en nach den Anforderungen.
\item
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%  Verwendbarkeitstabelle
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%\input{kommVVZ-ss24-verwendbarkeitstabelle.tex}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%  Dozentenliste für Abschlussarbeiten
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section*{Arbeitsgebiete f\"ur Abschlussarbeiten}
\addcontentsline{toc}{subsection}{Arbeitsgebiete f\"ur Abschlussarbeiten}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%  EUCOR: Verweis auf Basel, Strasbourg etc.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\newpage
\section*{Angebote der EUCOR-Partnerhochschulen}
\addcontentsline{toc}{subsection}{Angebote der EUCOR-Partnerhochschulen}
...
\medskip
        ...
        Die Veranstaltung deckt nur einen Teil des Moduls ab; die ECTS-Punkte werden erst für das vollständige Modul verbucht. 
            ...
            \ding{173}
        Im dualen M.Ed.-Studiengang nur in der Fächerkombination mit Physik vorgesehen. 
...
\medskip
            ...
            \ding{172}
        Im dualen M.Ed.-Studiengang nur in der Fächerkombination mit Informatik vorgesehen. 
...
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            ...
            cm}{\raggedright
                ...
                \end{itemize}             }}}
\\[2ex] \hline
\hline \rule[0mm]{0cm}{.6cm}SL: In jeden der drei Teile (Stochastik, Numerik, Optimierung) mindestens 50\% der Punkte in den Übungen. \rule[-3mm]{0cm}{0cm}
 &
\makecell[c]{\xmark}
\\
\hline \rule[0mm]{0cm}{.6cm}SL: Erfolgreiche Bearbeitung  der Programmieraufgaben. \rule[-3mm]{0cm}{0cm}
 &
\makecell[c]{\xmark}
\\
...
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            ...
            cm}{\raggedright
                \begin{itemize}\item
                    Algebra und Zahlentheorie (2HfB21, MEH21) -- 9~ECTS 
                \end{itemize}             }}}
 &
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            7
...
\medskip
            ...
            \ding{173}
        Zählt bei Bedarf als eines der drei Module 'Vorlesung mit Übung A' bis 'Vorlesung mit Übung C' und deckt dabei die Bedingung ab, dass eines zur Reinen Mathematik gehören muss. 

            \ding{174}
        Es zählen nur die bis Weihnachten bearbeitbaren Übungsblätter. 
...
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            ...
            cm}{\raggedright
                \begin{itemize}\item
                    Mathematische Vertiefung (MEd18, MEH21) -- 9~ECTS \item Reine Mathematik (MSc14) -- 11~ECTS \item Mathematik (MSc14) -- 11~ECTS 
                \end{itemize}             }}}
 &
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            7
...
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            ...
            cm}{\raggedright
                \begin{itemize}\item
                    Mathematische Vertiefung (MEd18, MEH21) -- 9~ECTS \item Angewandte Mathematik (MSc14) -- 11~ECTS \item Mathematik (MSc14) -- 11~ECTS 
                \end{itemize}             }}}
 &
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            7
...
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            ...
            cm}{\raggedright
                \begin{itemize}\item
                    Advanced Lecture in Numerics (MScData24) -- 9~ECTS \item Elective in Data (MScData24) -- 9~ECTS 
                \end{itemize}             }}}
\\[2ex] \hline
\hline \rule[0mm]{0cm}{.6cm}PL: Klausur (Dauer: 1 bis 3 Stunden) \rule[-3mm]{0cm}{0cm}
 &
...
\medskip
        ...
        Verwendbar bei Wahl der Option ''Individuelle Studiengestaltung''. 
            ...
            \ding{173}
        Zählt bei Bedarf als eines der drei Module 'Vorlesung mit Übung A' bis 'Vorlesung mit Übung C'. 
...
\clearpage\hrule\vskip1pt\hrule
\section*{\Large \href{ https://www.stochastik.uni-freiburg.de/de/lehre/ws-2024-2025/vorlesung-funktionentheorie-ws-2024-2025}{Funktionentheorie}}
...
Übung (2-stündig): Di, 16--18 Uhr, SR 127, \href{https://www.openstreetmap.org/?mlat=48.000637&mlon=7.846006#map=19/48.000636/7.846006}{Ernst-Zermelo-Str. 1}\\
...
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            ...
            cm}{\raggedright
                \begin{itemize}\item
                    Angewandte Mathematik (MSc14) -- 11~ECTS \item Mathematik (MSc14) -- 11~ECTS \item Advanced Lecture in Stochastics (MScData24) -- 11~ECTS \item Elective in Data (MScData24) -- 11~ECTS 
                \end{itemize}             }}}
 &
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            7
...
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            ...
            cm}{\raggedright
                \begin{itemize}\item
                    Angewandte Mathematik (MSc14) -- 11~ECTS \item Mathematik (MSc14) -- 11~ECTS \item Advanced Lecture in Numerics (MScData24) -- 11~ECTS \item Elective in Data (MScData24) -- 11~ECTS 
                \end{itemize}             }}}
 &
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            7
...
\clearpage\hrule\vskip1pt\hrule
\section*{\Large \href{ https://www.stochastik.uni-freiburg.de/de/lehre/ws-2024-2025/lecture-probability-theory-III-ws-2024-2025}{Wahrscheinlichkeitstheorie III (Stochastische Integration und Finanzmathematik)}}
...
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            ...
            cm}{\raggedright
                \begin{itemize}\item
                    Reine Mathematik (MSc14) -- 5.5~ECTS \item Mathematik (MSc14) -- 5.5~ECTS 
                \end{itemize}             }}}
 &
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            7
            cm}{\raggedright
                \begin{itemize}\item
                    Vertiefungsmodul (MSc14) -- 5.25~ECTS 
                \end{itemize}             }}}
 &
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            7
...
\medskip
        ...
        Verwendbar bei Wahl der Option ''Individuelle Studiengestaltung''. 
            ...
            \ding{173}
        Die Prüfungen werden von Prof. Wang abgenommen. 
...
\hfill{E}\\
Vorlesung: Mo, 10--12 Uhr, HS 3042, \href{https://www.openstreetmap.org/?mlat=47.993945&mlon=7.847285#map=19/47.993945/7.847285}{KG III}\\
Übung: Di, 8--10 Uhr, HS 1015, \href{https://www.openstreetmap.org/?mlat=47.993706&mlon=7.846060#map=19/47.993706/7.846060}{KG I}\\
...
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            ...
            cm}{\raggedright
                \begin{itemize}\item
                    Wahlpflichtmodul Mathematik (BSc21) -- 6~ECTS \item Elective in Data (MScData24) -- 6~ECTS 
                \end{itemize}             }}}
 &
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            7
...
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            ...
            cm}{\raggedright
                \begin{itemize}\item
                    Angewandte Mathematik (MSc14) -- 5.5~ECTS \item Mathematik (MSc14) -- 5.5~ECTS 
                \end{itemize}             }}}
 &
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            7
...
\medskip
        ...
        Verwendbar bei Wahl der Option ''Individuelle Studiengestaltung''. 
            ...
            \ding{173}
        Die Prüfungen werden von Prof. Große abgenommen. 
...
\clearpage\hrule\vskip1pt\hrule
\section*{\Large \href{ https://www.stochastik.uni-freiburg.de/de/lehre/ws-2024-2025/lecture-markov-chains-ws-2024-2025}{Markov-Ketten}}
...
\clearpage\hrule\vskip1pt\hrule
\section*{\Large Mathematische Physik}
\addcontentsline{toc}{subsection}{Mathematische Physik\ \textcolor{gray}{(\em Wolfgang Soergel)}}
\vskip-2ex
{\it Wolfgang Soergel}
\hfill{D}\\
Vorlesung: Di, 16--18 Uhr, SR 403, \href{https://www.openstreetmap.org/?mlat=48.000637&mlon=7.846006#map=19/48.000636/7.846006}{Ernst-Zermelo-Str. 1}\\
\subsubsection*{\large
    Inhalt:
}
...
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            ...
            cm}{\raggedright
                \begin{itemize}\item
                    Wahlmodul im Optionsbereich (2HfB21) -- 3~ECTS \item Wahlmodul (BSc21) -- 3~ECTS \item Mathematische Ergänzung (MEd18) -- 3~ECTS 
                \end{itemize}             }}}
 &
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            4
...
Studierende im B.Sc. Mathematik können einen Vortrag übernehmen, dann zählt die Veranstaltung als Seminar.
...
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            ...
            cm}{\raggedright
                \begin{itemize}\item
                    Fachdidaktische Entwicklung (MEd18, MEH21, MEB21) -- 4~ECTS 
                \end{itemize}             }}}
\\[2ex] \hline
\hline \rule[0mm]{0cm}{.6cm}SL: Regelmäßige Teilnahme an der Veranstaltung (wie in der Prüfungsordnung definiert). \rule[-3mm]{0cm}{0cm}
 &
\makecell[c]{\xmark}
\\
\hline \rule[0mm]{0cm}{.6cm}SL: Aktive mündliche Beteiligung und Ausarbeitung und Präsentation einer Unterrichtssequenz. \rule[-3mm]{0cm}{0cm}
 &
\makecell[c]{\xmark}
\\
\hline
...
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            ...
            cm}{\raggedright
                ...
                \end{itemize}             }}}
\\[2ex] \hline
\hline \rule[0mm]{0cm}{.6cm}SL: Die Anforderungen werden von der Pädagogischen Hochschule festgelegt und im dortigen Modulhandbuch oder in der Veranstaltung bekannt gegeben. \rule[-3mm]{0cm}{0cm}
 &
\makecell[c]{\xmark}
\\
\hline
...
\addcontentsline{toc}{subsection}{Modul ''Fachdidaktische Forschung'':\ \textcolor{gray}{(\em Dozent:inn:en der PH Freiburg, Frank Reinhold)}}
\vskip-2ex
{\it Dozent:inn:en der PH Freiburg, Frank Reinhold}
\hfill{D}\\
Teil 1: Seminar 'Fachdidaktische Entwicklungsforschung zu ausgewählten Schwerpunkten': Mo, 14--16 Uhr, Raum noch nicht bekannt, \href{https://www.openstreetmap.org/?mlat=47.98132\&mlon=7.89420\#map=17/47.98132/7.89420}{PH Freiburg}\\
Teil 2: Seminar 'Methoden der mathematikdidaktischen Forschung ': Mo, 16--19 Uhr, Raum noch nicht bekannt, \href{https://www.openstreetmap.org/?mlat=47.98132\&mlon=7.89420\#map=17/47.98132/7.89420}{PH Freiburg}\\
...
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            ...
            cm}{\raggedright
                \begin{itemize}\item
                    Fachdidaktische Forschung (MEd18, MEH21, MEB21) -- 4~ECTS 
                \end{itemize}             }}}
\\[2ex] \hline
\hline \rule[0mm]{0cm}{.6cm}SL: Regelmäßige Teilnahme an der Veranstaltung (wie in der Prüfungsordnung definiert). \rule[-3mm]{0cm}{0cm}
 &
...
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            ...
            cm}{\raggedright
                \begin{itemize}\item
                    Wahlmodul (BSc21) -- 3~ECTS \item Mathematische Ergänzung (MEd18) -- 3~ECTS \item Wahlmodul (MSc14) -- 3~ECTS \item Wahlmodul (MScData24) -- 3~ECTS 
                \end{itemize}             }}}
\\[2ex] \hline
...
\clearpage\hrule\vskip1pt\hrule
\section*{\Large \href{ https://www.stochastik.uni-freiburg.de/de/lehre/ws-2024-2025/seminar-maschine-learning-ws-2024-2025}{Maschinelles Lernen und Stochastische Analysis}}
