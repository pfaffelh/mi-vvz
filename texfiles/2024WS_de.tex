...
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            ...
            \end{flushleft} }}}
\\[2ex] \hline
\hline \rule[0mm]{0cm}{.6cm}SL: Abgegebene Übungsaufgaben müssen auf Aufforderung durch den Tutor/die Tutorin hin im Tutorat präsentiert werden können. \rule[-3mm]{0cm}{0cm}
 &
\makecell[c]{\xmark}
\\
\end{tabularx}
...
\makecell[c]{\xmark}
\\
\hline \rule[0mm]{0cm}{.6cm}SL: Erreichen von mindestens 50\% der Punkte, die insgesamt durch die Bearbeitung der für die Übung ausgegebenen Übungsaufgaben und Online-Kurztests erreicht werden können. Durch das Vorrechnen von Aufgaben im Tutorat können Bonuspunkte erreicht werden. \rule[-3mm]{0cm}{0cm}
 &
\makecell[c]{\xmark}
\\
\end{tabularx}
...
\makecell[c]{\xmark}
\\
\hline \rule[0mm]{0cm}{.6cm}SL: Regelmäßige Teilnahme (wie in der Prüfungsordnung definiert) an einem der Tutorate zur Vorlesung. \rule[-3mm]{0cm}{0cm}
 &
\makecell[c]{\xmark}
\\
\hline \rule[0mm]{0cm}{.6cm}SL: Vorrechnen von mindestens einer Übungsaufgaben im Tutorat. \rule[-3mm]{0cm}{0cm}
 &
\makecell[c]{\xmark}
\\
\end{tabularx}
...
\makecell[c]{\xmark}
\\
\hline \rule[0mm]{0cm}{.6cm}Zählt bei Bedarf als eines der drei Module Vorlesung mit Übung A bis Vorlesung mit Übung C und deckt die Bedingung ab, dass mindestens eines davon zur Reinen Mathematik gehören muss. \rule[-3mm]{0cm}{0cm}
 &
 &
 &
 &
\makecell[c]{\xmark}
\\
\hline \rule[0mm]{0cm}{.6cm}Zählt bei Bedarf als eines der vier Module Vorlesung mit Übung A bis Vorlesung mit Übung D und deckt die Bedingung ab, dass mindestens eines davon zur Reinen Mathematik gehören muss. \rule[-3mm]{0cm}{0cm}
 &
 &
 &
 &
...
\makecell[c]{\xmark}
 &
\\
\hline \rule[0mm]{0cm}{.6cm}PL: Mündliche Prüfung (Dauer ca. 30 Minuten) über Analysis I–III am Ende des Moduls. (Die bestandenen Klausuren zu Analysis I und II und die bestandene Übung zu Analysis III sind Zulassungsvoraussetzungen). \rule[-3mm]{0cm}{0cm}
 &
\makecell[c]{\xmark}
 &
\\
...
\makecell[c]{\xmark}
\\
\hline \rule[0mm]{0cm}{.6cm}SL: Mindestens zweimaliges Vorrechnen von Übungsaufgaben im Tutorat. \rule[-3mm]{0cm}{0cm}
 &
\makecell[c]{\xmark}
 &
\makecell[c]{\xmark}
...
\makecell[c]{\rotatebox[origin=l]{90}{\parbox{
            ...
            \end{flushleft} }}}
\\[2ex] \hline
\hline \rule[0mm]{0cm}{.6cm}Nur sinnvoll als Ergänzung zur gleichnamigen Vorlesung. \rule[-3mm]{0cm}{0cm}
 &
\makecell[c]{\xmark}
\\
